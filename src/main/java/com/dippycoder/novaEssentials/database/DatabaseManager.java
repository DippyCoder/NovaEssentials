...
public class DatabaseManager {
    ...
    private Connection playtimeConn;
    ...
    public void disconnect() {
        ...
        close(playtimeConn, "playtime.db");
    }
    ...
    public long loadPlaytime(UUID uuid) {
        if (playtimeConn == null) return 0;
        try (PreparedStatement ps = playtimeConn.prepareStatement(
