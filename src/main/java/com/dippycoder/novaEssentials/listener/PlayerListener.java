...
import com.dippycoder.novaEssentials.command.FNukeCommand;
...
public class PlayerListener implements Listener {
    ...
    public void onJoin(PlayerJoinEvent event) {
        ...
        plugin.getPlaytimeManager().onJoin(player.getUniqueId());
    ...
    public void onEntityExplode(EntityExplodeEvent event) {
        if (FNukeCommand.isFnukeTnt(event.getEntity().getUniqueId())) {
            event.blockList().clear();
            FNukeCommand.removeFnukeTnt(event.getEntity().getUniqueId());
        }
    }
